...
for  n in range(1,400):
    data = np.load('C:/Users/a/Desktop/chewei/%d.npy'%n)


# n = 1
# while n<400:
#     data = np.load('C:/Users/a/Desktop/chewei/%s.npy'%n)#打开一个文件夹的同一类型的所有文件。
#     print(data)
    ...
    #     print(df)
        ...
        #plt.show()
        fig.savefig('C:/Users/a/Desktop/cycle4/%d号车位%d.png'%(n,i),pdi=1000,bbox_inches='tight')
        # 存于我们想要放的地方，进行不同命名储存。
        plt.close()
